      ...
      <div className={viewMode === 'grid' ? 'grid md:grid-cols-2 lg:grid-cols-3 gap-6' : 'space-y-4'}>
        {filteredMaterials.length === 0 ? (
          ...
          filteredMaterials.map((material) => (
            <div key={material.id} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-blue-200 transition-all duration-300">
              {viewMode === 'grid' ? (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="bg-gray-50 dark:bg-gray-900 px-3 py-1.5 rounded-lg text-center font-medium text-xs text-gray-700 dark:text-gray-300">{material.chapter}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                        <span className="bg-gray-50 dark:bg-gray-900 px-3 py-1 rounded-lg font-medium">{material.chapter}</span>
                      </div>
                    </div>
                  </div>
